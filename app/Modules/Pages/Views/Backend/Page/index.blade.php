...
@include('Pages.Views.Backend.Modals.add_route')
@include('Pages.Views.Backend.Modals.edit_route')
...
@section('scripts')
	...
	<script type="text/javascript">
		function initTiny(element,layout){
			tinyMCE.init({
	            'formats' : {
	...
	<script type="text/javascript">
		$(function(){
			...
			$(document).on('click', '.edit', function () {
				...
				initTiny('#edit-route textarea.layout',layout);
	            tinymce.activeEditor.setContent(layout);
