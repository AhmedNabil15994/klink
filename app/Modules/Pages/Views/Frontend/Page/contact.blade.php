				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="row">
						<div class="contact-form">
							...
							<form action="{{URL::to('page/contact/store/new')}}" method="post">
								@csrf
								<div class="row">

									<div class="col-sm-6">
										<div class="form-group">
											<input type="text" name="name" placeholder="{{trans('frontend/about.name')}}">
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<input type="email" name="email" placeholder="{{trans('frontend/about.email2')}}">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="form-group">
											<textarea name="message" placeholder="{{trans('frontend/about.message')}}"></textarea>
										</div>
									</div>
