...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'buissnessCustomer' => \App\Http\Middleware\buissnessCustomer::class,
        'normal_user' => \App\Http\Middleware\NormalUser::class,
        'driver' => \App\Http\Middleware\Driver::class,
        'user' => \App\Http\Middleware\User::class,
        'completed'=>\App\Http\Middleware\CompletedProfile::class,
        'svgImage'=>\App\Http\Middleware\DynamicSvgImages::class,
