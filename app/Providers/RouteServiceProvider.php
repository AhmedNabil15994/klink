...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     *
     * Define the "drivers" routes for the driver application.
     * hese routes all receive session state, CSRF protection, etc.
     * @return void
     */
    ...
    protected function mapModulesRoutes()
    {
        Route::middleware('web')->namespace($this->namespace)->group(function (){
            ...
            require app_path('Modules/Package/routes.php');
