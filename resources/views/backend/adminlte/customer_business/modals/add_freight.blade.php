<div id="add-freight" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h4 class="modal-title">New Freight</h4>
				@if (count($errors) > 0)
			...
			<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="form-control persons">
								...
								<option value="{{$person->id}}" data-address="{{$person->address->fullAddress()}}">{{$person->name()}}</option>
								@endforeach
							</select>
						</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="checkbox" name="type" class="icheckbox_flat drop" checked>&nbsp;Drop
