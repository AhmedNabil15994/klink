<div id="edit-bill" class="modal fade">
            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control billNumber" readonly type="text" placeholder="{{trans('backend/bills.number')}}" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" style="position:relative;">
                            {{-- <span class="reGenerate" id="orderGeneratorBill"><i class="fa fa-refresh"></i></span> --}}
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control billDate" id="billDateEdit"  type="text" placeholder="{{trans('backend/bills.billDate')}}" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
...
<script>
    // Replace the <textarea id="newEmailType"> with a CKEditor
        ...
        window.addEventListener('load', function (){
            ...
            $('#orderGeneratorBill').click(function(){
                ...
                $.ajax({
                   ...
                   success:function(data){
                        ...
                        $('#orderGeneratorBill').removeClass('rotating');
                   }
                });
            })
            // $("#orderGeneratorBill").click();

            $('#edit-bill').on('click','.btn-success',function(e){
                e.preventDefault();
                e.stopPropagation();
                var $formData = new FormData();
                $formData.append('id',window.lastUpdatedBill);
                $formData.append('number',$('#edit-bill .billNumber').val());
                $formData.append('order_num',$('#edit-bill .orderNumber').val());
                $formData.append('customerName',$('#edit-bill .customer').val());
                $formData.append('order_cost',$('#edit-bill .orderCost').val());
                $formData.append('tax',$('#edit-bill .orderTax').val());
                $formData.append('fees',$('#edit-bill .orderFees').val());
                $formData.append('discount',$('#edit-bill .orderDiscount').val());
                $formData.append('invionce_date',$('#edit-bill .billDate').val());
                $formData.append('payment_type',$('#edit-bill .paymentType').val());
                $formData.append('note',$('#edit-bill .note').val());
                // $formData.append('is_active',$('#edit-bill .is_active').val());
                // console.log();
                $.ajaxSetup({
                  headers: {
