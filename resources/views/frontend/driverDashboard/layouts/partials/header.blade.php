...
<nav class="dashnav">
    ...
    <div class="topnav">
        <ul class="topnav__list">
            ...
            <!--user control-->
            <li class="listItem user-space">

                <a href="" class="list-link">
                    <img src="{{asset('images/user.jpg')}}" alt="user">
                </a>
                <!--user control-->
                <ul class="dropDown user-control">
                    ...
                    <li class="dropDown__list">
                        <a href="{{route('user.profile')}}" class="downlink">
                            <div class="list-icon">
                                <span class="icon fas fa-cog
                    ...
                    <li class="dropDown__list">
                        <a href="{{route('company.logout')}}" class="downlink">
                            <div class="list-icon">
                                <span class="icon fas fa-sign-out-alt
                            ...
                            <div class="text">
                                <span class="text-box">
                                    {{trans('frontend/dashboard.logout')}}
                                </span>
                            </div>
                        </a>
                    </li>
