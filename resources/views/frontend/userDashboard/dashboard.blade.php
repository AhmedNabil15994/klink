                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="card card--blue">
                                    ...
                                    <a href="{{route(Helper::type($profile->status).'.activeorders')}}" class="card__link">
                                        <div class="card__go">
                                ...
                                <div class="card card--green">
                                    ...
                                    <div class="card__counter">
                                        ...
                                        <div class="counterInfo">
                                            ...
                                            <span class="type">
                                                {{trans('frontend/dashboard.spent')}}
                                            </span>
                                        </div><!--CounterInfo-->
                                    </div><!--card Counter-->
                                    ...
                                    <a href="#Myorders" class="card__link">
                                        <div class="card__go">
                                                    <span class="card_name">{{trans('frontend/dashboard.spent')}}</span>
                                                    <span class="arrow fas fa-long-arrow-alt-right"></span>
                                        </div>
                                    </a>
                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table__body">
                                                    ...
                                                    <tr class="table__body--row">              
                                                        <?php 
                                                            $ship = \DB::table('shippings')->where('id',$one->ship_id)->first();
                                                        ?>
                                                        @if(isset($ship))
                                                        <td class="car-head clearfix">
                                                            ...
                                                            <div class="car-details">
                                                                <span class="car-name">{{$ship->title}}</span>
                                                            </div>
                                                        </td>
                                                        @else
														<td></td>	
                                        ...
                                        <div class="order-data">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table__body">
                                                    ...
                                                    <?php 
                                                        $ship = \DB::table('shippings')->where('id',$one_order->ship_id)->first();
                                                    ?>
                                                    <tr class="table__body--row">              
...
var myChart = new Chart(ctx2, {
    ...
    data: {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec'],
        datasets: [{
            label: '{{trans('frontend/dashboard.spent')}}',
            data: data2,
            borderColor: "#7AA536",
