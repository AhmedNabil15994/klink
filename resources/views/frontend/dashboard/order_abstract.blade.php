...
<style type="text/css">
    ...
    @media print {
        ...
        .order-space .orderCard::-webkit-scrollbar {
            width: 0 !important
        }
    ...
    @include('frontend.dashboard.layouts.partials.newHeader')
        ...
        <div class="company-invoice">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="total-value">
                                <p class="test">
                                    <span>{{trans('frontend/order.subtotal')}}: </span> {!! Helper::convNum($subtotal) !!} €
                                </p>

                                

                                <p class="test">
                                    <span>{{trans('frontend/order.total')}}: </span> {!! Helper::convNum($subtotal) !!} €
                                </p>

                                <p>
                                    <span>{{trans('frontend/order.paid')}}: </span> {!! Helper::convNum($paid) !!} €
                                </p>

                                <p class="due-amount">
                                    <span>{{trans('frontend/order.amount_due')}}: </span> {!! Helper::convNum(round($subtotal - $paid , 2)) !!} €
                                </p>
            ...
            <div class="row actions" style="padding: 0;margin: 0;margin-bottom: 2.5rem;">
                <a href="{{route('download_pdf2',['id'=> $order->order_id,'num'=>$num])}}" class="btn btn-xs btn-default"><i class="fa fa-save fa-1x"></i> {{trans('frontend/order.download')}}</a>
