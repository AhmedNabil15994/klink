                        ...
                        <div class="col-xs-12">
                            ...
                            <fieldset>
                                ...
                                <div class="update-group">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <label for="info">{{trans('frontend/dashboard.tax_no')}}</label>
                                        </div>
                                        <div class="col-xs-8">
                                            <input type="text" id="tax_no" class="update-input" placeholder="{{trans('frontend/dashboard.tax_no')}}" required value="{{$profile['tax_no']}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="update-group">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <label for="info">{{trans('frontend/dashboard.secure_no')}}</label>
                                        </div>
                                        <div class="col-xs-8">
                                            <input type="text" id="secure_no" class="update-input" placeholder="{{trans('frontend/dashboard.secure_no')}}" required value="{{$profile['secure_no']}}">
                                        </div>
                                    </div>
                                </div>
