...
<aside class="sideMenu rale">
    ...
    <ul class="sideList">
        ...
        <li class="sideList__item big">
            <a href="{{route(Helper::type($profile->status).'.dashboard')}}">
                <div class="sideIcon">
    ...
    <ul class="user-navi">
        ...
        <li class="user-navi_list big">
            ...
            <ul class="user-navi_sub">
                ...
                <li class="{{$class}}"><a href="{{route(Helper::type($profile->status).'.drivers')}}">{{trans('frontend/dashboard.drivers')}} </a></li>
                <li><a href="{{route(Helper::type($profile->status).'.vehicles')}}">{{trans('frontend/dashboard.vehicle')}}</a></li>
                @endif
